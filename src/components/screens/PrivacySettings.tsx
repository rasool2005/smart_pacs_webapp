  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-6">
        ...
        <p className="text-gray-600 text-sm mt-1">Manage your privacy and data preferences</p>
      </div>
            ...
            <div>
              <div className="flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-14 items-center rounded-full transition-colors flex-shrink-0 ${
                    settings.shareUsage ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
                >
                  <span
                    className={`inline-block h-5 w-5 transform rounded-full bg-white transition-transform ${
            ...
            <div>
              <div className="flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-14 items-center rounded-full transition-colors flex-shrink-0 ${
                    settings.personalizedExperience ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
                >
                  <span
                    className={`inline-block h-5 w-5 transform rounded-full bg-white transition-transform ${

import svgPaths from "./svg-tajcz6ohlo";
import imgImageInvalidImage from "figma:asset/15be78b5ab68f80d2e67116d10e3d0fe2695ea0b.png";

function ImageInvalidImage() {
  return (
    <div className="absolute h-[255.989px] left-0 opacity-50 top-0 w-[339.5px]" data-name="Image (Invalid image)">
...
function Container1() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.4)] content-stretch flex h-[255.989px] items-center justify-center left-0 top-0 w-[339.5px]" data-name="Container">
      <Container />
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[79.985px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#c10007] text-[14px] top-[-1px] w-[210px]">This does not appear to be a valid MRI medical scan. The image looks like a regular photo or non-medical content.</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[48.039px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#c10007] text-[12px] top-0 w-[175px]">Please upload only medical imaging files (MRI scans) for AI analysis.</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="flex-[1_0_0] h-[222.529px] min-h-px min-w-px relative" data-name="Container">
...
function Container6() {
  return (
    <div className="content-stretch flex gap-[15.993px] h-[222.529px] items-start relative shrink-0 w-full" data-name="Container">
      <Container3 />
      <Container5 />
    </div>
  );
...
function Container7() {
  return (
    <div className="bg-white h-[289.071px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
...
function Container9() {
  return (
    <div className="h-[19.996px] relative shrink-0 w-full" data-name="Container">
      <Container8 />
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[13.98px] not-italic text-[#193cb8] text-[14px] top-[-1px] w-[155px]">Medical MRI scans only</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-gradient-to-r from-[#9810fa] h-[55.966px] relative rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 to-[#155dfc] w-full" data-name="Button">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[169.91px] not-italic text-[16px] text-center text-white top-[14.27px] translate-x-[-50%]">Try Another Image</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-white h-[58.515px] relative rounded-[16px] shrink-0 w-full" data-name="Button">
      ...
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[169.25px] not-italic text-[#364153] text-[16px] text-center top-[15.54px] translate-x-[-50%]">Back to Home</p>
    </div>
  );
}
...
function AiScannerScreen() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col gap-[24px] h-[925.986px] items-start relative shrink-0 w-full" data-name="AIScannerScreen">
      <Container2 />
      <Container7 />
      <Container17 />
      <Container18 />
...
function App() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col h-[1249.93px] items-start left-0 pt-[203.947px] px-[24px] top-0 w-[387.499px]" data-name="App">
      <AiScannerScreen />
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] flex-[1_0_0] h-[43.976px] min-h-px min-w-px relative rounded-[16.4px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[54.89px] not-italic text-[16px] text-center text-white top-[8.27px] translate-x-[-50%]">X-Ray</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="bg-white flex-[1_0_0] h-[43.976px] min-h-px min-w-px relative rounded-[16.4px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[54.1px] not-italic text-[#9810fa] text-[16px] text-center top-[8.27px] translate-x-[-50%]">MRI</p>
      </div>
    </div>
  );
}

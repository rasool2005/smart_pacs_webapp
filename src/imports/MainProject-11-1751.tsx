import svgPaths from "./svg-52bm3of7p0";

function Paragraph() {
  return (
    <div className="absolute content-stretch flex h-[19.996px] items-start left-0 top-0 w-[106.455px]" data-name="Paragraph">
...
function Heading() {
  return (
    <div className="absolute h-[31.986px] left-0 top-[20px] w-[106.455px]" data-name="Heading 1">
      <p className="absolute css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[32px] left-0 not-italic text-[24px] text-white top-[-0.73px]">Dr. Smith</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute h-[51.983px] left-0 top-0 w-[106.455px]" data-name="Container">
      <Paragraph />
      <Heading />
    </div>
  );
...
function Text() {
  return <div className="absolute bg-[#fb2c36] left-[32.01px] rounded-[42770700px] size-[7.987px] top-[7.99px]" data-name="Text" />;
}
...
function BottomNav() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[73.234px] items-start left-0 pt-[13.265px] px-[24px] top-[843.25px] w-[387.499px]" data-name="BottomNav">

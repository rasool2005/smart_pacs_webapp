import svgPaths from "./svg-93lxouzz1b";
...
function Paragraph() {
  return (
    <div className="h-[79.985px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#c10007] text-[14px] top-[-1px] w-[210px]">This does not appear to be a valid XRAY medical scan. The image looks like a regular photo or non-medical content.</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[48.039px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#c10007] text-[12px] top-0 w-[184px]">Please upload only medical imaging files (XRAY scans) for AI analysis.</p>
    </div>
  );
}
